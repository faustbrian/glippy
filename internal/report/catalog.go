...
func RenderRuleCatalogMarkdown(registry *rules.Registry) ([]byte, error) {
	...
	output.WriteString("<!-- Code generated by go generate ./internal/report; DO NOT EDIT. -->\n\n")
	output.WriteString("This catalog is rendered from the same immutable rule metadata used by the\n")
	output.WriteString("registry, scheduler, configuration decoder, and `gox explain`.\n")
	output.WriteString("Preset membership and defaults describe the current development binary and are\n")
