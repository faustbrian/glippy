...
func (nilnessRule) Metadata() Metadata {
	return Metadata{
		...
		KnownLimitations: []string{
			...
			"The shared SSA program propagates no-return behavior and explicit nil/error return relationships through the selected package and same-module imported helpers. Third-party helpers outside the selected modules remain conservative unless they match an exact standard-library terminal API.",
