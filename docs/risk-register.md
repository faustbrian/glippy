...
| Gofmt workflow conflict | Controlled | Recorded fixed-point divergence classes, migration guidance, and a sole-formatter adoption boundary | Obtain human approval of a real migration and remove the competing formatter there |
