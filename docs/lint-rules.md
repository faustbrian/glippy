...
- Functions defined in build-constrained or GOOS/GOARCH-suffixed files do not export return-state
  relationships because an unloaded platform or tag variant may have a different contract.
