...
| --- | --- |
| Product, binary, and module name | ADR 0001 records immutable Gox v0.1 history; ADR 0016 owns the post-v0.1 Glippy migration and first-stable compatibility window |
