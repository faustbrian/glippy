...
| Cache inputs and invalidation | ADR 0008 and cache specification; opt-in fact-bearing analyzer consumer and explicit bounded pruning implemented, CLI and native-tier caching deferred |
