...
Final source-bearing candidate run
[`33056742540`](https://github.com/faustbrian/glippy/actions/runs/33056742540)
passed the native budget, expanded contract, archive, and cross-runner
reproducibility matrix for revision `18004f2` with Go 1.27.0. All four native
